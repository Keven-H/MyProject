...
+(void)getCropImageInVc:(UIViewController *)controller   withCallback:(getImageBlock) getimageblock
{
    [WDImageManager sharedManager].tailorType = WDTailorTypeAuto;
...
+(void)getCropImageInCaVc:(UIViewController *)controller   withCallback:(getImageBlock) getimageblock
{
     [WDImageManager sharedManager].tailorType = WDTailorTypeAuto;
    [WDImageManager sharedManager].callBack = [getimageblock copy];
     [WDImageManager sharedManager].tailorSize = CGSizeZero;;
    ...
    picker.delegate = (id) [WDImageManager sharedManager];;
...
+(void)getCropImageInLibaryVc:(UIViewController *)controller   withCallback:(getImageBlock) getimageblock
{
     [WDImageManager sharedManager].tailorType = WDTailorTypeAuto;
    [WDImageManager sharedManager].callBack = [getimageblock copy];
     [WDImageManager sharedManager].tailorSize = CGSizeZero;;

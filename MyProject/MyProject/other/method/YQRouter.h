...
extern NSString *const YQRouterParameterURL;
extern NSString *const YQRouterParameterCompletion;
extern NSString *const YQRouterParameterUserInfo;

/**
 *  routerParameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^YQRouterHandler)(NSDictionary *routerParameters);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^YQRouterObjectHandler)(NSDictionary *routerParameters);
@interface YQRouter : NSObject
